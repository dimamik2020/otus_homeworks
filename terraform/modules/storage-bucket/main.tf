...
#  log_bucket_name = var.bucket_name+"_logs"
  log_bucket_name =format("%s%s",var.bucket_name,"_logs")

}

# Storage Bucket
resource "google_storage_bucket" "bucket_box" {
...
resource "google_storage_bucket_acl" "bucket_acl" {
  bucket      = google_storage_bucket.bucket_box.name
